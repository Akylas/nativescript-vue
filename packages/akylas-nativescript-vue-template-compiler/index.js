...
/*!
 * Akylas-NativeScript-Vue-Template-Compiler v2.0.6
 * (Using Vue v2.6.7)
...
var view$2 = require('tns-core-modules/ui/core/view');
...
function isView(view) {
  return view instanceof view$2.View
}

function isLayout(view) {
  return view instanceof layoutBase.LayoutBase
}

function isContentView(view) {
  return view instanceof contentView.ContentView
}
...
var VUE_VERSION = '2.6.7';
var NS_VUE_VERSION = '2.0.6';
