...
/*!
 * Akylas-NativeScript-Vue-Template-Compiler v2.1.11
 * (Using Vue v2.6.10)
...
var modules = [class_, style, vTemplate, for_, router, view];
...
var NS_VUE_VERSION = process.env.NS_VUE_VERSION || '2.1.11';
