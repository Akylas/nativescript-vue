...
const builtInComponents = require("./runtime/components");
const elementMap = {};
...
registerElement('DetachedText', () => require('tns-core-modules/ui/placeholder').Placeholder, {
    skipAddToDom: true
});
registerElement('Comment', () => require('tns-core-modules/ui/placeholder').Placeholder);
registerElement('Document', () => require('tns-core-modules/ui/proxy-view-container').ProxyViewContainer, {
    skipAddToDom: true
});
