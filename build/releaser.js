...
inquirer
  ...
  .then(({version, releaseTag}) => {
    ...
    return runCommands(`
      ...
      cd packages/nativescript-akylas-vue-template-compiler && npm version ${version} && npm publish${releaseTag ? ' --tag ' + releaseTag : ''}
      git add -A
      git add -f dist/index.js dist/index.js.map packages/nativescript-akylas-vue-template-compiler/index.js
